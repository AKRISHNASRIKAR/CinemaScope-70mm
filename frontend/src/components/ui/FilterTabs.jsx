...
const FilterTabs = ({ active, onChange, dark = true }) => (
  <div className="flex items-center overflow-x-auto scrollbar-hide" role="group" aria-label="Movie filters" style={{ gap: "clamp(1rem, 3vw, 2rem)", paddingBottom: "clamp(0.25rem, 0.5vh, 0.5rem)" }}>
    {TABS.map((tab) => {
